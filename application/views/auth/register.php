            ...
            <div class="row bs-reset">
                <div class="col-md-6 login-container bs-reset">
                    ...
                    <div class="login-content">
                        <h1>Register</h1>
                        <p> Register an account to start managing your sensors </p>
                        <form action="<?php echo base_url('authentication/create_account') ?>" class="login-form" method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <input class="form-control form-control-solid placeholder-no-fix form-group" type="text" autocomplete="off" placeholder="Username" name="identity" required/> 
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
