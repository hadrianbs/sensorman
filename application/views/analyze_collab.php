...
$(function () {
    $.getJSON('<?php echo base_url('data_controller/getCollabCharts')."/".$collabdata[0]->COLLABID."/"."all" ?>', function (data) {
...
<script type="text/javascript">
$(function () {
    $.getJSON('<?php echo base_url('data_controller/getCollabCharts')."/".$collabdata[0]->COLLABID."/"."max" ?>', function (data) {
...
<script type="text/javascript">
$(function () {
    $.getJSON('<?php echo base_url('data_controller/getCollabCharts')."/".$collabdata[0]->COLLABID."/"."min" ?>', function (data) {
...
<script type="text/javascript">
$(function () {
    $.getJSON('<?php echo base_url('data_controller/getCollabCharts')."/".$collabdata[0]->COLLABID."/"."average" ?>', function (data) {
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="<?php echo base_url('viewsensor')."/".$collabdata[0]->COLLABID ?>"> <?php echo $collabdata[0]->COLLABNAME ?> </a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                                    ...
                                    <div class="portlet light bordered">
                                        ...
                                        <div class="portlet-body">
                                            <table class="table table-striped table-bordered table-hover" id="maxtab">
                                                ...
                                                <tbody>
                                                    <?php foreach ($maxcollabdata as $row) { ?>
                                                    <tr>
                                    ...
                                    <div class="portlet light bordered">
                                        ...
                                        <div class="portlet-body">
                                            <table class="table table-striped table-bordered table-hover" id="mintab">
                                                ...
                                                <tbody>
                                                    <?php foreach ($mincollabdata as $row) { ?>
                                                    <tr>
                                                        <td> <?php echo $row->sensordate ?> </td>
                                                        <td> <?php echo $row->sensordata ?> </td>
                                                    </tr>
                                    ...
                                    <div class="portlet light bordered">
                                        ...
                                        <div class="portlet-body">
                                            <table class="table table-striped table-bordered table-hover" id="avgtab">
                                                ...
                                                <tbody>
                                                    <?php foreach ($averagecollabdata as $row) { ?>
                                                    <tr>
                                                        <td> <?php echo $row->sensordate ?> </td>
                                                        <td> <?php echo $row->sensordata ?> </td>
                                                    </tr>
