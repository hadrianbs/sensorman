                                                        ...
                                                        <div class="portlet-body">
                                                            <table class="table table-striped table-bordered table-advance table-hover">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <a href="javascript:;"> Sensor(s) </a>
                                                                        </td>
                                                                        <td class="hidden-xs"> <?php echo $sensorNumber; ?> </td>
                                                                        <td> 
                                                                            <?php if (($userdata->sensor_limit - $sensorNumber) == 0) { ?>
                                                                            10
                                                                            <span class="label label-warning label-sm"> Full! </span>
                                                                            <?php } 
                                                                            else { ?>
                                                                            <?php echo ($userdata->sensor_limit - $sensorNumber) ?>
                                                                            <?php } ?>
                                                                        </td>
                                                                        
                                                                    <tr>
                                                                        <td>
                                                                            <a href="javascript:;"> Collaborative Sensors </a>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <a href="javascript:;"> Total Sensor Data </a>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <a href="javascript:;"> Total Collab Sensor Data </a>
                                                                        </td>
